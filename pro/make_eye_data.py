...
def make_eye_data(method):
    ...
    np.save('../openclosed_train_nn.dat', xtrain)
    np.save('../openclosed_class_train_nn.dat', ytrain)
    ...
    # Classification = 0 for open and 1 for closed    
    ytrain[(len(opentrain)):,0] = 1
    np.save('../openclosed_val_nn.dat', xtrain)
    np.save('../openclosed_class_val_nn.dat', ytrain)
